...
<head>
    ...
    <script>
        function confirmarBorrado(event) {
            var confirmacion = confirm("¿Estás seguro de que deseas borrar este juego?");
            if (!confirmacion) {
...
<table id="resultados">
        <thead>
            ...
            <tr>
                ...
                <td><img src="<?php echo $results['image']; ?>" alt="../insertados/error.png" width="100"></td>
                <td><form action="../nivel2/borrar_juego.php" method="GET" onsubmit="confirmarBorrado(event)">
                <input type="hidden" id="name" name="name" value="<?php echo $results['name']; ?>">
                <button type="submit">Borrar</button>
                </form>
                </td>
                <td><form action="../nivel2/modificar_juego.php" method="GET">
                <input type="hidden" id="name" name="name" value="<?php echo $results['name']; ?>">
